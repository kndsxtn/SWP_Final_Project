<%-- Document : procurement-detail Description: Chi tiết yêu cầu mua sắm (format theo allocation-detail) --%>
                        ...
                        <div class="row h-100">
                            ...
                            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                                ...
                                <div class="cfms-page-header">
                                    <h2><i class="bi bi-cart-check me-2"></i>Chi tiết yêu cầu PROC-${proc.procurementId}
                                    </h2>
                                    <div class="page-header-actions">
                                        <%-- Asset Staff: Edit + Cancel (chỉ khi Pending và là người tạo) --%>
                                            ...
                                            <%-- Hiệu trưởng / Trưởng phòng TC-KT: Approve + Reject (khi Pending) --%>
                                                ...
                                                <%-- Asset Staff: Stock-in khi Approved --%>
                                                    <c:if
                                                        test="${sessionScope.user.roleName == 'Asset Staff' && (proc.status == 'Approved' || proc.status == 'Partially_Received')}">
                                                        <a class="btn btn-primary me-2"
                                                            href="${pageContext.request.contextPath}/request/procurement-stockin?id=${proc.procurementId}">
                                                            <i class="bi bi-box-arrow-in-down me-1"></i>Nhập kho
                                                        </a>
                                                    </c:if>

                                                    <%-- Asset Staff: After stock-in, allow jumping to assign instances
                                                        (proc is still Approved or Partially_Received) --%>
                                                        <c:if
                                                            test="${sessionScope.user.roleName == 'Asset Staff' && (proc.status == 'Approved' || proc.status == 'Partially_Received') && proc.allocationRequestId != null}">
                                                            <a class="btn btn-success me-2"
                                                                href="${pageContext.request.contextPath}/request/allocation-assign?id=${proc.allocationRequestId}">
                                                                <i class="bi bi-list-check me-1"></i>Chọn cá thể cấp
                                                                phát
                                                            </a>
                                                        </c:if>
                                ...
                                <div class="detail-card">
                                    ...
                                    <c:if test="${proc.allocationRequestId != null}">
                                        <div class="detail-row">
                                            ...
                                            <span class="detail-value">
                                                <a
                                                    href="${pageContext.request.contextPath}/request/allocation-detail?id=${proc.allocationRequestId}">REQ-${proc.allocationRequestId}</a>
                                            </span>
                                        </div>
                                    </c:if>
                                    <div class="detail-row">
                                        ...
                                        <span class="detail-value">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <span class="cfms-badge">Nhập kho thiếu</span>
                                                </c:otherwise>
                                            </c:choose>
                                        </span>
                                    </div>
                                ...
                                <div class="detail-card">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="mb-0"><i class="bi bi-box-seam me-2"></i>Danh sách tài sản yêu cầu
                                            mua</h5>
                                        ...
                                        <span class="badge bg-primary"
                                            ...
                                            <i class="bi bi-calculator me-1"></i>Tổng: <strong>${totalQty}</strong> tài
                                            sản
                                        </span>
                                    </div>
                                                    ...
                                                    <div class="asset-images">
                                                        <c:forEach items="${d.asset.images}" var="img">
                                                            <img src="${pageContext.request.contextPath}/${img.imageUrl}"
                                                                alt="${img.description}" class="img-thumb"
