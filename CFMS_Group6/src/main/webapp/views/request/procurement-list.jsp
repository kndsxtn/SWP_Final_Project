<%-- Document : procurement-list Description: Danh sách yêu cầu mua sắm (tương tự allocation-list) Author : Nguyen Dang
    Khang --%>
                                                        ...
                                                        <tr>
                                                            <td colspan="10">
                                                                <div class="cfms-table-empty">
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when
                                                                            test="${not empty keyword || not empty statusFilter}">
                                                    ...
                                                    <c:otherwise>
                                                        <c:forEach items="${list}" var="proc" varStatus="loop">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <fmt:formatDate value="${proc.createdDate}"
                                                                    ...
                                                                    <c:forEach items="${proc.details}" var="d">
                                                                        <div class="d-flex align-items-center mb-1"
                                                                            ...
                                                                            <span class="small flex-grow-1">
                                                                                <strong>${d.asset.assetCode}</strong> –
                                                                                ${d.asset.assetName}
                                                                            </span>
                                                                        </div>
                                                                    </c:forEach>
                                                                ...
                                                                <td>
                                                                    <c:forEach items="${proc.details}" var="d">
                                                                        <span
                                                                            class="d-block small">${d.asset.category.categoryName}</span>
                                                                    </c:forEach>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <c:choose>
                                                                        <c:when
                                                                            test="${proc.allocationRequestId != null}">
                                                                ...
                                                                <td>
                                                                    <c:choose>
                                                                        <c:when test="${proc.status == 'Pending'}">
                                                                            <span
                                                                                class="cfms-badge cfms-badge-pending">Chờ
                                                                                duyệt</span>
                                                                        </c:when>
                                                                        <c:when test="${proc.status == 'Approved'}">
                                                                            <span
                                                                                class="cfms-badge cfms-badge-approved">Đã
                                                                                duyệt</span>
                                                                        </c:when>
                                                                        <c:when test="${proc.status == 'Rejected'}">
                                                                            <span
                                                                                ...
                                                                                <span
                                                                                    class="cfms-badge cfms-badge-rejected">Từ
                                                                                    chối</span>
                                                                                <c:if
                                                                                    test="${not empty proc.reasonReject}">
                                                                                    <i class="bi bi-info-circle text-danger ms-1"
                                                                                        data-bs-toggle="tooltip"
                                                                                        title="${proc.reasonReject}"></i>
                                                                                </c:if>
                                                                            </span>
                                                                        </c:when>
                                                                        <c:when test="${proc.status == 'Cancelled'}">
                                                                            <span
                                                                                class="cfms-badge cfms-badge-rejected">Đã
                                                                                hủy</span>
                                                                        </c:when>
                                                                        <c:when test="${proc.status == 'Completed'}">
                                                                            <span
                                                                                class="cfms-badge cfms-badge-completed">Hoàn
                                                                                thành</span>
                                                                        </c:when>
                                                                        <c:when
                                                                            test="${proc.status == 'Partially_Received'}">
                                                                            <span
                                                                                class="cfms-badge cfms-badge-completed">Đã
                                                                                nhận một phần</span>
                                                                        </c:when>
                                                                ...
                                                                <td class="col-action">
                                                                    ...
                                                                    <%-- Asset Staff: Stock-in khi Approved và có liên
                                                                        kết allocation --%>
                                                                        <c:if
                                                                            test="${sessionScope.user.roleName == 'Asset Staff' && proc.status == 'Approved' && proc.allocationRequestId != null}">
                                                                            <form method="post"
                                                                                action="${pageContext.request.contextPath}/request/procurement-stockin"
                                                                                class="d-inline ms-1">
                                                                                <input type="hidden" name="id"
                                                                                    value="${proc.procurementId}">
                                                                                <button type="button"
                                                                        ...
                                                                        <%-- Asset Staff: After stock-in, allow assign
                                                                            link (proc is still Approved) --%>
                                                                            <c:if
                                                                                test="${sessionScope.user.roleName == 'Asset Staff' && proc.status == 'Approved' && proc.allocationRequestId != null}">
                                                                            ...
                                                                            <%-- Asset Staff: Edit + Cancel (chỉ khi
                                                                                Pending và là người tạo) --%>
                                                                                <c:if
                                                                                    test="${proc.status == 'Pending' && sessionScope.user.roleName == 'Asset Staff' && proc.createdBy == sessionScope.user.userId}">
                                                                                    ...
                                                                                    <form method="post"
                                                                                        action="${pageContext.request.contextPath}/request/procurement-cancel"
                                                                                        class="d-inline ms-1">
                                                                                        <input type="hidden" name="id"
                                                                                            value="${proc.procurementId}">
                                                                                        <button type="button"
                                                                                ...
                                                                                <%-- Hiệu trưởng / Trưởng phòng TC-KT:
                                                                                    Approve + Reject (khi Pending) --%>
                                                                                    <c:if
                                                                                        test="${proc.status == 'Pending' && (sessionScope.user.roleName == 'Principal' || sessionScope.user.roleName == 'Finance Head')}">
                                                                                        <form method="post"
                                                                                            action="${pageContext.request.contextPath}/request/procurement-approve"
                                                                                            class="d-inline ms-1">
                                                                                            <input type="hidden"
                                                                                                name="id"
                                                                                                value="${proc.procurementId}">
                                                                                        ...
                                                                                        <form method="post"
                                                                                            action="${pageContext.request.contextPath}/request/procurement-reject"
                                                                                            class="d-inline ms-1">
                                                                                            <input type="hidden"
                                                                                                name="id"
                                                                                                value="${proc.procurementId}">
