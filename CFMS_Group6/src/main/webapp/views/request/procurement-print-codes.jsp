                            ...
                            <div class="cfms-page-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="no-print">
                                    <c:if test="${proc.allocationRequestId != null}">
                                        <a href="${pageContext.request.contextPath}/request/allocation-assign?id=${proc.allocationRequestId}"
                            ...
                            <div class="card shadow-sm mb-4 no-print">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h5 class="card-title mb-1 text-primary">Đơn mua sắm
                                                PROC-${proc.procurementId}</h5>
                                            <p class="text-muted mb-0">Hệ thống đã ghi nhận số lượng thực tế và tự động
                                                sinh mã định danh (Barcode) cho từng thiết bị.</p>
                                        </div>
                            ...
                            <div id="printArea">
                                        ...
                                        <div class="col">
                                            <div class="barcode-card">
                                                ...
                                                <div style="font-size: 0.75rem; color: #888;">
                                                    ${ad.asset.category.categoryName}</div>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </div>
                                <c:if test="${empty instances}">
                                    <div class="alert alert-info border-0 rounded-3 shadow-sm text-center p-4">
                                        ...
                                        <h6 class="mb-0">Không tìm thấy mã cá thể nào được sinh ra từ quá trình nhập kho
                                            này.</h6>
                                    </div>
                                </c:if>
                            </div>
