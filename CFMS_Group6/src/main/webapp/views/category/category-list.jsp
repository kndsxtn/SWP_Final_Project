                                ...
                                <div class="cfms-paging" ${tool.totalPage <=1 ? 'hidden' :''}>
                                    ...
                                    <ul class="pagination">
                                        <c:if test='${tool.index!=0}'>
                                            ...
                                            <a class="page-link"
                                                href='ViewCategoryController?index=${tool.index-1}'>Previous</a>
                                        </c:if>
                                        <c:forEach var='index' begin='${tool.pageStart}' end='${tool.pageEnd}'>
                                            <a class="page-link"
                                                href='ViewCategoryController?index=${index}'>${index+1}</a>
                                        </c:forEach>
                                        <c:if test='${tool.index!=tool.totalPage-1}'>
                                            <a class="page-link"
                                                href='ViewCategoryController?index=${tool.index+1}'>Next</a>
