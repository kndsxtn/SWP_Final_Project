...
<body>
    ...
    <div class="login-card fade-in-down">
        ...
        <form action="${pageContext.request.contextPath}/loginHome" method="POST">
            ...
            <a href="${pageContext.request.contextPath}/google-login" profile openid&redirect_uri=http://localhost:8080/CFMS_Group6/login-google&response_type=code&client_id=358588036824-k59d5a958nq7pn96g5ht3bjcgvtbuoqs.apps.googleusercontent.com&approval_prompt=force" class="btn-google w-100">
