    ...
    <body>
        ...
        <div class="login-card p-4 fade-in-down">
            <div class="card-header-custom">
                ...
                <h3 class="title-text">Hệ thống Quản lý Thiết bị</h3>
            ...
            <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/loginHome" method="POST">
                    ...
                    <div class="text-center mt-3">
                        <a href="login-google">
                            <img src="${pageContext.request.contextPath}/assets/img/google-btn.png" alt="Login with Google" style="width: 200px;">
                        </a>
                    </div>
